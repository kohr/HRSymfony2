 ...
 */
class MrStartBundleEntityMrUserProxy extends \Mr\StartBundle\Entity\MrUser implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addAcquaintance($acquaintance);
    }

    public function getAcquaintance()
    {
        $this->__load();
        return parent::getAcquaintance();
    }
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'algorithm', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'createdAt', 'updatedAt', 'id', 'firstname', 'lastname', 'facebookID', 'steps', 'groups', 'myFriends', 'friendsWithMe', 'acquaintance');
    }
